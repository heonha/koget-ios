...
struct FloatingButtonTestView: View {
    var body: some View {
        ScreenIconsAndText()
    }
}

struct FloatingButtonTestView_Previews: PreviewProvider {
    static var previews: some View {
        FloatingButtonTestView()
...
struct ScreenIconsAndText: View {
    ...
    var body: some View {
        ...
        let menu1 = FloatingButton(mainButtonView: mainButton1, buttons: textButtons, isOpen: $isOpen)
            .straight()
            .direction(.top) // 아이콘 기준 메뉴 위치
            .alignment(.left) // 아이콘 기준 메뉴 Alignment
            .spacing(10)
